    ...
    <main className="min-h-screen flex">
      ...
      <div className="max-w-md text-center">
        {isLoggingIn ? (
          ...
          <>
            <h1 className="text-4xl font-bold text-indigo-700 mb-4">Welcome Back</h1>
            <p className="text-gray-600">Access your AI-powered legal assistant anytime.</p>
          </>
        )}
      </div>
    </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-6">
          <h2 className="text-2xl font-semibold text-gray-800">Login to Cyberlegal.AI</h2>
          ...
          <div className="flex justify-between text-sm mt-4 text-gray-600">
            <Link href="#" className="hover:underline text-indigo-600">Forgot password?</Link>
