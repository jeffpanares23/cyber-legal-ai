(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_8327bc79._.js", {
    ...
    const handleSend = async (e)=>{
        ...
        try {
            ...
            if (data.sources && data.sources.length > 0) {
                const formattedSources = data.sources.map((src)=>`- ${src}`).join("\n");
                const sourceReply = {
                    sender: "bot",
                    content: `📚 **Sources:**\n${formattedSources}`
                };
...
//# sourceMappingURL=src_8327bc79._.js.map